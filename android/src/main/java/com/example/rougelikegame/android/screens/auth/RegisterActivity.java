 ...
 * It provides fields for personal information, validates the input,
 * checks for existing emails, and creates a new user record in the database.
 */
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * Orchestrates the registration process, creating a user object and checking if the email exists.
     */
    ...
    /**
     * Finalizes user creation in the database and redirects to the MainMenu.
     *
